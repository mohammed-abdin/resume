...
<h2 style="color: #232f3e; font-size: 18px; border-bottom: 2px solid #ff9900; padding-bottom: 5px; text-transform: uppercase; letter-spacing: 0.5px; margin-top: 30px;">Education</h2>
<ul style="font-size: 14px; padding-left: 20px; margin: 0 0 20px 0;">
...
<h2 style="color: #232f3e; font-size: 18px; border-bottom: 2px solid #ff9900; padding-bottom: 5px; text-transform: uppercase; letter-spacing: 0.5px; margin-top: 30px;">Certifications</h2>
<ul style="font-size: 14px; padding-left: 20px; margin: 0;">
